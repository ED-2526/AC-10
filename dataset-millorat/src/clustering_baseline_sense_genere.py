...
for k in K_RANGE:
    ...
    # Cálculem SSE = suma de distàncies fins al seu centre
    sse = km.inertia_
    sse_list.append(sse)

    # Calculem Silhouette Score = mesura entre -1 i 1 (com de separats estan els clusters)
...
# Amb PCA reduïm les dimensions -> 2 components principals per fer un gràfic 2D
...
# Entrada que afegirem al fitxer experiments.md
entry = f"""
